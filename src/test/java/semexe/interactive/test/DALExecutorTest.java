package semexe.interactive.test;


import semexe.*;
import semexe.interactive.DALExecutor;
import semexe.interactive.Item;
import semexe.interactive.World;
import semexe.interactive.voxelurn.Color;
import semexe.interactive.voxelurn.Voxel;
...
public class DALExecutorTest {
    ...
    public static Predicate<World> selectedSize(int n) {
        return x -> {
    ...
    private static Set<Item> real(Set<Item> all) {
