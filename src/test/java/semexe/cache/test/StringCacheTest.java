package semexe.cache.test;

import semexe.cache.FileStringCache;
import semexe.basic.IOUtils;
import semexe.basic.MemUsage;
...
public class StringCacheTest {
    private static int numLines(BufferedReader in) throws IOException {
        int n = 0;
