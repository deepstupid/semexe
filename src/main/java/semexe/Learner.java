...
public class Learner {
    ...
    private static void logEvaluationStats(Evaluation evaluation, String prefix) {
    ...
    private void printLearnerEventsIter(Example ex, int iter, String group) {
        ...
        if (opts.dumpFeaturesAndCompatibility) {
            for (Derivation deriv : ex.predDerivations) {
                ...
                for (Map.Entry<String, Double> stringDoubleEntry : features.entrySet()) {
                    double v = stringDoubleEntry.getValue();
                    fields.add(stringDoubleEntry.getKey() + '=' + v);
                }
