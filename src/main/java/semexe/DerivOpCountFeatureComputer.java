...
public class DerivOpCountFeatureComputer implements FeatureComputer {
    ...
    private static void extractOperationsRecurse(Derivation deriv, Map<String, Integer> opCounter) {
        // Basic case: no rule
    ...
    private static void addFeatures(Derivation deriv, Map<String, Integer> opCounter) {
