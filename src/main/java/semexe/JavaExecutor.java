...
public class JavaExecutor extends Executor {
    ...
    private static Value toValue(Object obj) {
        ...
        if (obj instanceof Integer) return new NumberValue((Integer) obj);
    ...
    private Object processFormula(Formula formula, ContextValue context) {
        ...
        if (formula instanceof CallFormula) {  // Invoke the function.
            ...
            List<Object> args = new ArrayList(call.args.size()+1);
            ...
            if (id.contains(opts.contextPrefix)) {
                args.add(context);
            ...
            List<Object> var = args.subList(1, args.size());
            if (id.startsWith(".")) // Instance method
                return invoke(id.substring(1), args.get(0), var.toArray(new Object[var.size()]));

            else  // Static method
                return invoke(id, null, args.toArray(new Object[args.size()]));
        }
    ...
    private static int typeCastCost(Class[] types, Object[] args) {
    ...
    private static int typeCastCost(Class<?> type, Object arg) {
