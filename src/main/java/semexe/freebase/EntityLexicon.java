...
import semexe.ValueFormula;
import semexe.cache.StringCache;
import semexe.cache.StringCacheUtils;
import semexe.freebase.index.FbEntitySearcher;
import semexe.freebase.index.FbIndexField;
import semexe.freebase.lexicons.EntrySource;
import semexe.freebase.lexicons.LexicalEntry;
import semexe.freebase.lexicons.LexicalEntry.EntityLexicalEntry;
import semexe.freebase.lexicons.TokenLevelMatchFeatures;
...
public final class EntityLexicon {
    ...
    public List<EntityLexicalEntry> lookupFreebaseSearchEntities(String query) {
        ...
        for (FreebaseSearch.Entry e : response.entries) {
            ...
            entities.add(new EntityLexicalEntry(query, query, Collections.singleton(e.name),
                    ...
                    FreebaseTypeLookup.getEntityTypes(id), entityFeatures));
        }
        return entities;
    }

    public static List<EntityLexicalEntry> lookupEntries(FbEntitySearcher searcher, String textDesc) throws ParseException, IOException {
    ...
    private static int editDistance(String query, String name) {
