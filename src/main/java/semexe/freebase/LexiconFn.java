...
import semexe.freebase.lexicons.LexicalEntry.BinaryLexicalEntry;
import semexe.basic.*;
...
public class LexiconFn extends SemanticFn {
    ...
    public static class Options {
        ...
        @Option
        public int maxUnaryEntries = Integer.MAX_VALUE;
        @Option
        public int maxBinaryEntries = Integer.MAX_VALUE;

        @Option(gloss = "Verbose")
        public int verbose = 0;
        @Option(gloss = "Class name for lexicon")
        public String lexiconClassName;
        @Option
        public boolean useHistogramFeatures = true;
    }
