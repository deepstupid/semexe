...
import semexe.LanguageInfo.DependencyEdge;
import semexe.MergeFormula.Mode;
...
public class BridgeFn extends SemanticFn {
    ...
    private static final Formula intFormula = Formulas.formula(LispTree.proto.tree("(fb:type.object.type fb:type.int)"));
    private static final Formula floatFormula = Formulas.formula(LispTree.proto.tree("(fb:type.object.type fb:type.float)"));
    ...
    public static FeatureVector getBinaryBridgeFeatures(BinaryFormulaInfo bInfo) {
        ...
        features.add("BridgeFn", "domain=" + BinaryFormulaInfo.extractDomain(bInfo.formula));
    ...
    private static boolean isCvt(Derivation headDeriv) {
    ...
    private static Set<String> getSupertypes(SemType type, Set<String> supertypes) {
    ...
    private static boolean badDomain(String binary) {
    ...
    private static boolean badDomain(Formula formula) {
    ...
    private static boolean varIsBinary(Formula formula, String var) {
    ...
    private static Formula buildBridge(Formula headFormula, Formula modifierFormula, Formula binary) {
    ...
    private static Formula buildBridgeFromCvt(JoinFormula headFormula, Formula modifierFormula, Formula binary) {
        Formula join = new JoinFormula(binary, modifierFormula);
    ...
    public class LazyBridgeFnDerivs extends MultipleDerivationStream {
        ...
        private Derivation nextInject() {
            ...
            res.addFeature("BridgeFn", "domain=" + BinaryFormulaInfo.extractDomain(currBridgingInfo.bInfo.formula));
