...
public final class WordNet {
     ...
     */
    private final Set<EdgeType> loadedEdges = EnumSet.noneOf(EdgeType.class);
    /**
    ...
    public static WordNet loadPrologWordNet(File path) {
        ...
        //
        {
            for (String line : ObjectBank.getLineIterator(new File(path, "wn_s.pl"))) {
                ...
                final String word = fields[2].substring(
    ...
    private void createStructuralEdges() {
        ...
        loadedEdges.addAll(Arrays.asList(EdgeType.WORD_TO_WORDTAG, EdgeType.WORDTAG_TO_WORD,
