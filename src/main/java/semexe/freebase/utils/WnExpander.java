...
import semexe.freebase.utils.WordNet.EdgeType;
import semexe.freebase.utils.WordNet.WordID;
import semexe.freebase.utils.WordNet.WordNetID;
...
public class WnExpander {
    ...
    private WordNet wn;
    private Set<EdgeType> edgeTypes = EnumSet.noneOf(EdgeType.class);
    /**
    ...
    public Set<String> getHypernyms(String phrase) {
        Set<WordNetID> phraseSynsets = phraseToSynsets(phrase);
        Set<WordNetID> hypernyms = new HashSet<>(expandSynsets(phraseSynsets, EdgeType.HYPONYM));
