...
import semexe.DateValue;
import semexe.DescriptionValue;
import semexe.Json;
...
public final class FileUtils {
    ...
    public static void generatePredictionFile(String inFile, String outFile) throws IOException {
        ...
        for (String line : IOUtils.readLines(inFile)) {
            ...
            LispTree goldTree = LispTree.proto.tree(tokens[1]);
            ...
            if (tokens.length > 2) {
                LispTree predictedTree = LispTree.proto.tree(tokens[2]);
