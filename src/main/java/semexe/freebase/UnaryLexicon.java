...
import semexe.freebase.lexicons.LexicalEntry.LexiconValue;
import semexe.freebase.lexicons.LexicalEntry.UnaryLexicalEntry;
...
public final class UnaryLexicon {
    ...
    public void save(String outFile) throws IOException {
        ...
        for (Map.Entry<String, List<UnaryLexicalEntry>> stringListEntry : lexemeToEntryList.entrySet()) {
            for (UnaryLexicalEntry uEntry : stringListEntry.getValue()) {
                LexiconValue lv = new LexiconValue((String) stringListEntry.getKey(), uEntry.formula, uEntry.source.toString(), uEntry.alignmentScores);
     ...
     */
    private static boolean valid(UnaryLexicalEntry lexicalEntry) {
    ...
    public static class Options {
        ...
        public String unaryLexiconFilePath = "unaryInfoStringAndAlignment.txt";
    ...
    public static class UnaryLexEntrybyFeaturesComparator implements Comparator<UnaryLexicalEntry> {
