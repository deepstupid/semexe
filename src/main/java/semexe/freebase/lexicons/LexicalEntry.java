package semexe.freebase.lexicons;

import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonProperty;
import semexe.Formula;
import semexe.SemType;
import semexe.SemTypeHierarchy;
    ...
    public static class BinaryLexicalEntry extends LexicalEntry {
        ...
        public boolean identicalFormulaInfo(Object other) {
            ...
            if (!unitId.equals(otherBinary.unitId))
                return false;
            return unitDescription.equals(otherBinary.unitDescription);
        }
        ...
        public String toString() {
            if (stringRepn == null) {
                ...
                sb.append(", ").append(expectedType1).append(" x ").append(expectedType2);
                if (unitId != null) {
                    sb.append(", ").append(unitId).append(':').append(unitDescription);
                }
                if (alignmentScores.size() > 0)
                    sb.append(", ").append(alignmentScores);
    ...
    public static class LexicalEntrySerializer {
        ...
        static LispTree counterToLispTree(Counter<String> counter) {
            ...
            for (String feature : counter.keySet())
                tree.addChild(LispTree.proto.newList(feature, String.valueOf(counter.getCount(feature))));
            return tree;
        }
        ...
        static LispTree featureMapToLispTree(Map<String, Double> featureMap) {
            LispTree tree = LispTree.proto.newList();
            for (Map.Entry<String, Double> stringDoubleEntry : featureMap.entrySet())
                tree.addChild(LispTree.proto.newList((String) stringDoubleEntry.getKey(), String.valueOf(stringDoubleEntry.getValue())));
            return tree;
        }
        ...
        public static LispTree entryToLispTree(LexicalEntry rawEntry) {
            ...
            if (rawEntry instanceof LexicalEntry.EntityLexicalEntry) {
                ...
                result.addChild(String.valueOf(entry.popularity));
                result.addChild(String.valueOf(entry.distance));
