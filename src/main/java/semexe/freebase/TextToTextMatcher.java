...
public class TextToTextMatcher {
    ...
    private static void extractWordSimilarityFeatures(List<String> exampleTokens, List<String> examplePosTags, Set<String> fbDescs, FeatureVector vector) {
    ...
    private static void addFeaturesToVector(Counter<String> features, String prefix, FeatureVector vector) {
