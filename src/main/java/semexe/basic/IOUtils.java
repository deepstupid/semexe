...
public class IOUtils {
    ...
    public static BufferedReader openIn(File path) throws IOException {
        ...
        return openIn(path.getName(), is);
    }


    public static BufferedReader openIn(String path, InputStream is) throws IOException {
    ...
    public static BufferedReader openInHard(String path) {
        try {
            ...
            try {
                return openIn(path, Resources.getResource(path).openStream());
    ...
    public static void writeObjFile(String path, Object obj) throws IOException {
        writeObjFile(new File(path), obj);
    }
    ...
    public interface LineMunger {
        void beforeLine(boolean isContinuation);

        void afterFullLine(String line); // Called when a full line is read.
    }
