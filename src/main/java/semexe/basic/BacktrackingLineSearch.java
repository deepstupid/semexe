...
public class BacktrackingLineSearch {
    ...
    private static String formatDoubleArray(double[] x) {
    ...
    public static class Options {
        @Option
        public double stepSizeDecrFactor = 0.9;
        @Option
        public double stepSizeIncrFactor = 1.3;
        @Option(gloss = "Try to reduce the step size for at most this many times while the objective is not improving")
        public int maxTries = 100;
        @Option(gloss = "Stop optimizing when the L2 norm of gradient drops below this")
        ...
        @Option(gloss = "Just take one step")
