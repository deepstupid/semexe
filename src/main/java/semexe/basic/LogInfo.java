...
public class LogInfo {
    ...
    public static int getIndLevel() {
        return getInfo().getIndLevel();
    }
    ...
    public static void fails(String format, Object... args) {
        getInfo().fails(format, args);
    }

    public static void fail(Object o) {
        ThreadLogInfo.fail(o);
    }

    public static void logsForce(String format, Object... args) {
        getInfo().logsForce(format, args);
    }

    ////////////////////////////////////////////////////////////

    public static void logsForce(Object o) {
        getInfo().logsForce(o);
    }

    public static void logss(String format, Object... args) {
        getInfo().logss(format, args);
    }
...
class ThreadLogInfo {
    ...
    public void setFileOut(PrintWriter newFileOut) {
    ...
    public void dbgs(String format, Object... args) {
    ...
    public void error(Object o) {
        if (LogInfo.numErrors++ < LogInfo.maxPrintErrors) print("ERROR: " + o + '\n');
    }

    public void warnings(String format, Object... args) {
        warning(String.format(format, args));
    }

    public void warning(Object o) {
        if (LogInfo.numWarnings++ < LogInfo.maxPrintWarnings) print("WARNING: " + o + '\n');
    }
    ...
    private LogRun parentRun() {
        return runs.get(indLevel - 1);
    }

    private LogRun thisRun() {
        return runs.get(indLevel);
    }

    private LogRun childRun() {
        return runs.get(indLevel + 1);
    }

    // If we were to print a new line, should we print?
    private boolean indWithin() {
        return indLevel <= LogInfo.maxIndLevel;
    }

    private boolean parentIndWithin() {
        return indLevel - 1 <= LogInfo.maxIndLevel;
    }
