...
class BigDouble {
    ...
    private BigDouble(double M, int E) {
        this.M = M;
        this.E = E;
    }
    ...
    public static BigDouble zero() {
        return new BigDouble(1, MIN_E);
    }

    public static BigDouble invalid() {
        return new BigDouble(Double.NaN, 0);
    }
    ...
    public static BigDouble fromDouble(double M) {
        return newStandardizedBigDouble(M, 0);
    }
    ...
    public boolean updateMax(BigDouble d) {
        return updateMax(d.M, d.E);
    }
    ...
    public double toLogDouble() {
        return Math.log(M) + E * LOG_BASE;
    }

    public String toString() {
        return String.format("%s,%d", Fmt.D(M), E);
    }
}
