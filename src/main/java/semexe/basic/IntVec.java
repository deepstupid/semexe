...
public class IntVec/*TypeVec*/ implements MemUsage.Instrumented, Iterable<IntVec/*TypeVec*/.Entry> {
    ...
    public IntVec/*TypeVec*/(int/*type*/[] data, int start, int end) {
        ...
        System.arraycopy(data, start + 0, this.data, 0, n);
    }
    ...
    public int hashCode() {
        int h = n;
        for (int i = 0; i < n; i++)
            h = h * 29 +/* (Integer.valueOf(*/data[i]/*).hashCode())*/;
        return h;
    }
    ...
    private class EntryIterator implements Iterator<Entry>, Entry {
        ...
        public int/*type*/ getValue() {
            return data[index];
        }

        public void setValue(int/*type*/ value) {
            data[index] = value;
        }
    }
}
