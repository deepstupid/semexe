...
public class ImmutableAssocList<K, V> {
    ...
    public static <K, V> ImmutableAssocList<K, V> singletonList(K key, V value) {
        return new ImmutableAssocList<K, V>(key, value, emptyList, 1);
    }
    ...
    public ImmutableAssocList<K, V> prepend(K key, V value) {
        return new ImmutableAssocList<>(key, value, this, 1 + size);
    }
}
