...
public class IntIntIntVec/*TypeVec*/ implements MemUsage.Instrumented, Iterable<IntIntIntVec/*TypeVec*/.Entry> {
    ...
    // Append an element
    public void add(int/*type1*/ x, int/*type2*/ y, int/*type3*/ z) {
        setGrow(n, x, y, z);
    }
    ...
    public int/*type1*/[] getFirstData() {
        return data1;
    }

    public int/*type2*/[] getSecondData() {
        return data2;
    }

    public int/*type3*/[] getThirdData() {
        return data3;
    }
    ...
    private class EntryIterator implements Iterator<Entry>, Entry {
        ...
        @Override
        public int/*type1*/ getFirst() {
            return data1[index];
        }

        @Override
        public void setFirst(int/*type1*/ value) {
            data1[index] = value;
        }

        @Override
        public int/*type2*/ getSecond() {
            return data2[index];
        }

        @Override
        public void setSecond(int/*type2*/ value) {
            data2[index] = value;
        }

        @Override
        public int/*type3*/ getThird() {
            return data3[index];
        }

        @Override
        public void setThird(int/*type3*/ value) {
            data3[index] = value;
        }
    }
}
