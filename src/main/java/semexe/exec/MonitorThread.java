    ...
    public void run() {
        try {
            while (!stop) {
                ...
                Execution.putOutput("exec.errors", String.valueOf(LogInfo.getNumErrors()));
                Execution.putOutput("exec.warnings", String.valueOf(LogInfo.getNumWarnings()));
