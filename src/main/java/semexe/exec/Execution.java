...
public class Execution {
    ...
    public static ArrayList<String> addToView = new ArrayList<>();
    ...
    public static ArrayList<String> jarFiles = new ArrayList<>();
    ...
    public synchronized static String getInput(String s) {
