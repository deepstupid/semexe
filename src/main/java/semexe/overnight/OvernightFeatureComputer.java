...
import semexe.basic.BipartiteMatcher;
...
public class OvernightFeatureComputer implements FeatureComputer {
    ...
    private static void extractValueInFormulaFeature(Derivation deriv) {
    ...
    private static List<Formula> getCallFormulas(Derivation deriv) {
    ...
    private static void extractLogicalFormFeatures(Example ex, Derivation deriv) {
    ...
    private static void extractPhraseAlignmentFeatures(Example ex, Derivation deriv) {
    ...
    private static Map<String, Map<String, Double>> loadPhraseTable() {
    ...
    private static void addAndFilterLexicalFeature(Derivation deriv, String domain, String str1, String str2) {
    ...
    private static void extractLexicalFeatures(Example ex, Derivation deriv) {
    ...
    private static void extractStringSimilarityFeatures(Derivation deriv, String inputToken, String derivToken) {
    ...
    private static double[][] buildAlignmentMatrix(List<String> inputTokens, List<String> derivTokens) {
    ...
    private static double[][] buildLexicalAlignmentMatrix(List<String> inputTokens, List<String> derivTokens) {
        if (aligner == null) {
