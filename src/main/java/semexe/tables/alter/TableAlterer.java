...
import semexe.*;
import semexe.tables.*;
import semexe.tables.lambdadcs.DenotationUtils;
...
public class TableAlterer {
    private static final Comparator<TableCellProperties> NUMBER_COMP = new Comparator<>() {
        @Override
        public int compare(TableCellProperties o1, TableCellProperties o2) {
    ...
    private static final Comparator<TableCellProperties> DATE_COMP = new Comparator<>() {
        @Override
        public int compare(TableCellProperties o1, TableCellProperties o2) {
    ...
    public TableKnowledgeGraph constructAlteredGraph(int alteredTableIndex) {
        ...
        for (int j = 0; j < oldGraph.numColumns(); j++) {
            ...
            if (isAllDistinct) {
                ...
                nonFuzzyMatched.removeAll(newColumn);
    ...
    static int getGeometricRandom(int limit, Random random) {
    ...
    private static boolean isAllDistinct(List<TableCellProperties> properties) {
    ...
    private static boolean isSorted(List<TableCellProperties> properties, Comparator<TableCellProperties> comparator) {
        try {
