...
import semexe.tables.serialize.TableWriter;
...
public class TableAltererCache {
    ...
    public static boolean existsSaveDir(String id) {
    ...
    public TableKnowledgeGraph load(String id, int alteredTableIndex) {
        return load(id, String.valueOf(alteredTableIndex));
    }
    ...
    public static void dump(TableKnowledgeGraph graph, String id, int alteredTableIndex) {
        dump(graph, id, String.valueOf(alteredTableIndex));
    }

    // Dump table to |baseAlteredTablesDir|/nt-??/??.tsv
    public static void dump(TableKnowledgeGraph graph, String id, String alteredTableIndex) {
        if (opts.baseAlteredTablesDir == null)
