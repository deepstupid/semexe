...
import semexe.tables.serialize.SerializedDataset;
import semexe.tables.serialize.SerializedDumper;
import semexe.tables.test.CustomExample;
...
public class BatchTableAlterer implements Runnable {
    ...
    private static <T> void logGroups(Map<T, List<Integer>> groups, T annotated, String prefix) {
        // Sort by count
    ...
    public static void testSubset(DenotationData denotationData, Subset subset) {
   ...
   */
    ...
    public enum SubsetChooserSpec {NONE, ENTROPY, CACHED, PURE}
