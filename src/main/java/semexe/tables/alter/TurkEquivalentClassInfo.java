...
public class TurkEquivalentClassInfo {
    ...
    public String toString() {
        ...
        fields[0] = id;
        fields[1] = String.valueOf(numDerivs);
        fields[2] = String.valueOf(numClasses);
        fields[3] = String.valueOf(allTurkedTables);
        fields[4] = String.valueOf(agreedTurkedTables);
        ...
        fields[8] = String.valueOf(numDerivsMatched);
        fields[9] = String.valueOf(numClassesMatched);
