...
import semexe.tables.lambdadcs.LambdaDCSExecutor;
import semexe.basic.*;
...
public class DPDParserCheckerProcessor implements CustomExample.ExampleProcessor {
    ...
    static Derivation isCorrectFormulaOnBeam(CustomExample ex, List<Derivation> predDerivations) {
