...
public class SerializedDumper implements Runnable {
    ...
    private static LispTree exampleToLispTree(Example ex, List<Derivation> preds) {
    ...
    private static boolean isPruned(Derivation derivation) {
    ...
    private void writeMetadataLispTree(int size) {
        ...
        tree.addChild(LispTree.proto.newList("size", String.valueOf(size)));
        tree.print(out);
        out.println();
        out.flush();
    }
