...
public abstract class InfiniteUnaryDenotation extends UnaryDenotation {
    ...
    static class EverythingUnaryDenotation extends InfiniteUnaryDenotation {
        ...
        public Value toValue() {
            return new InfiniteListValue(Collections.singletonList("*"));
        }
        ...
        public boolean contains(Object o) {
            ...
            switch (comparator) {
                ...
                case ">=":
                    return comparison >= 0;
                default:
                    throw new LambdaDCSException(Type.invalidFormula, "Unknown comparator: %s", comparator);
            }
        }
    ...
    static class RangeEnds {
        ...
        public static UnaryDenotation andMerge(InfiniteUnaryDenotation xDeno, InfiniteUnaryDenotation yDeno) {
            ...
            if (comparison > 0) {
                ...
                leftComparator = x.leftComparator;
            } else if (comparison < 0) {
                leftValue = y.leftValue;
                leftComparator = y.leftComparator;
            } else {
                leftValue = x.leftValue;
            ...
            if (comparison < 0) {
                ...
                rightComparator = x.rightComparator;
            } else if (comparison > 0) {
                rightValue = y.rightValue;
                rightComparator = y.rightComparator;
            } else {
                rightValue = x.rightValue;
        ...
        public boolean contains(Object o) {
            ...
            switch (rangeEnds.leftComparator) {
                ...
                case ">=":
                    ...
                    break;
                default:
                    throw new LambdaDCSException(Type.invalidFormula, "Unknown leftComparator: %s", rangeEnds.leftComparator);
            }
            ...
            switch (rangeEnds.rightComparator) {
                ...
                case "<=":
                    ...
                    break;
                default:
                    throw new LambdaDCSException(Type.invalidFormula, "Unknown rightComparator: %s", rangeEnds.rightComparator);
            }
            return true;
        }
