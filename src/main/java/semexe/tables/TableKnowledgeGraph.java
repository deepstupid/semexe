...
import semexe.tables.lambdadcs.ExecutorCache;
import semexe.tables.lambdadcs.InfiniteUnaryDenotation;
import semexe.tables.lambdadcs.LambdaDCSException;
import semexe.tables.lambdadcs.LambdaDCSException.Type;
import semexe.tables.match.FuzzyMatcher;
import semexe.tables.serialize.TableReader;
...
public class TableKnowledgeGraph extends KnowledgeGraph implements FuzzyMatchable {
    ...
    public static void main(String[] args) {
        ...
        TableKnowledgeGraph graph = (TableKnowledgeGraph) KnowledgeGraph.fromLispTree(
                LispTree.proto.tree("(graph tables.TableKnowledgeGraph " + filename + ')'));
