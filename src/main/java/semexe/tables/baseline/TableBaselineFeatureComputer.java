...
public class TableBaselineFeatureComputer implements FeatureComputer {
    ...
    private static void defineAllFeatures(Derivation deriv, String name, List<PhraseInfo> phraseInfos) {
        defineUnlexicalizedFeatures(deriv, name);
        defineLexicalizedFeatures(deriv, name, phraseInfos);
    }

    private static void defineUnlexicalizedFeatures(Derivation deriv, String name) {
        deriv.addFeature("table-baseline", name);
    }

    private static void defineLexicalizedFeatures(Derivation deriv, String name, List<PhraseInfo> phraseInfos) {
        for (PhraseInfo phraseInfo : phraseInfos) {
