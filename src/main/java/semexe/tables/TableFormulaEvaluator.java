...
import semexe.tables.serialize.LazyLoadedExampleList;
import semexe.tables.serialize.SerializedDataset;
import semexe.tables.test.CustomExample;
import semexe.tables.test.TableFormulaCanonicalizer;
...
public class TableFormulaEvaluator extends TableValueEvaluator {
    ...
    protected void readAnnotationFile() {
        ...
        CustomExample.getDataset(Collections.singletonList(new Pair<>("annotated", opts.annotationPath)), new CustomExample.ExampleProcessor() {
            @Override
