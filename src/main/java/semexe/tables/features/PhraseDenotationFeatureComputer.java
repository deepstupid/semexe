...
public class PhraseDenotationFeatureComputer implements FeatureComputer {
    ...
    private static void extractCustomDenotationFeatures(Example ex, Derivation deriv, Collection<String> denotationTypes) {
    ...
    private static void extractPhraseDenotationFeatures(Example ex, Derivation deriv, Collection<String> denotationTypes) {
    ...
    private static void extractHeadwordDenotationFeatures(Example ex, Derivation deriv, Collection<String> denotationTypes) {
