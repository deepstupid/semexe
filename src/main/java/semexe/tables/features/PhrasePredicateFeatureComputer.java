...
import semexe.Example;
import semexe.FeatureComputer;
import semexe.FeatureExtractor;
...
public class PhrasePredicateFeatureComputer implements FeatureComputer {
    ...
    private static void defineFeatures(Example ex, Derivation deriv, PhraseInfo phraseInfo, PredicateInfo predicateInfo,
    ...
    private static void extractMissing(Example ex, Derivation deriv, List<PhraseInfo> phraseInfos, List<PredicateInfo> predicateInfos) {
        ...
        for (PredicateInfo predicateInfo : predicateInfos) {
            if (predicateInfo.type == PredicateInfo.PredicateType.BINARY || predicateInfo.type == PredicateInfo.PredicateType.ENTITY) {
