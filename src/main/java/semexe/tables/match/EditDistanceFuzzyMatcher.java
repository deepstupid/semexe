...
public class EditDistanceFuzzyMatcher extends FuzzyMatcher {
    ...
    static Collection<String> getAllSubstringCollapsedForms(String original) {
        ...
        for (int i = 0; i < tokens.length; i++) {
            ...
            for (int j = i; j < tokens.length; j++) {
                String phrase = sb.append(' ').append(tokens[j]).toString();
    ...
    static void debugPrint(String message, Map<String, Set<Formula>> target) {
     ...
     */
    protected static Collection<Formula> getUnions(Collection<Formula> formulas) {
    ...
    protected static Formula getUnion(Collection<Formula> formulas, String prefix) {
    ...
    protected static Set<Formula> filterFuzzyMatched(String normalized, Map<String, Set<Formula>> phraseToFormulas) {
