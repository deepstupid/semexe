...
import semexe.basic.StopWatchSet;
...
public class FeatureExtractor {
    ...
    static void extractRuleFeatures(Example ex, Derivation deriv) {
    ...
    static void extractSpanFeatures(Example ex, Derivation deriv) {
    ...
    static int getNumber(Value value) {
    ...
    static void extractDependencyFeatures(Example ex, Derivation deriv) {
    ...
    private static void addAllDependencyFeatures(LanguageInfo.DependencyEdge dependency,
    ...
    static void extractWhTypeFeatures(Example ex, Derivation deriv) {
    ...
    static void conjoinLemmaAndBinary(Example ex, Derivation deriv) {
    ...
    private static void extractUtterance(Derivation deriv, List<String> utterance) {
    ...
    private static void extractNonEntityLemmas(Example ex, Derivation deriv,
    ...
    private static List<String> extractBinaries(Formula formula) {
     ...
     */
    private static void extractBigramFeatures(Example ex, Derivation deriv) {
        ...
        if (!opts.lexicalBigramParaphrase) {
            for (Map.Entry<Integer, Integer> integerIntegerEntry : bigramCounts.entrySet())
                deriv.addFeature("bigram", "distance " + integerIntegerEntry.getKey() + " - " + integerIntegerEntry.getValue());
        }
    }

    // Joins arrayList of strings into string
    static String join(List<String> l, String delimiter) {
