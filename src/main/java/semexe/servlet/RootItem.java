...
public class RootItem extends Item {
    ...
    protected Value getIntrinsicFieldValue(String fieldName) throws MyException { // OVERRIDE
        if (fieldName.equals("logUpdates")) return new Value(String.valueOf(ServletLogInfo.logUpdates));
        if (fieldName.equals("verbose")) return new Value(String.valueOf(ServletLogInfo.verbose));
