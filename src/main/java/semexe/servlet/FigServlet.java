...
public class FigServlet extends HttpServlet {
    ...
    protected static void printInfo(WebState state, Permissions perm) {
        // Print some info
    ...
    private static void handleOperation(WebState state, Permissions perm, OperationRP req, Item item) throws MyException, IOException {
    ...
    private static class UpdaterThread extends Thread {
        ...
        public void hit() {
            sleepInterval = initSleepInterval;
            interrupt();
        }

        public UpdateSpec getUpdateSpec() {
            return new UpdateSpec(updateQueue);
        }
    }
}
