...
public class CommandUtils {
    public static CommandNode parse(String line, CommandEnv cmdEnv) {
        ...
        if (line.isEmpty()) return FuncCommandNode.noOpCmd;
    ...
    public static CommandNode parseRecordCommand(String line) {
        ...
        for (int k = 0; k < tokens.size(); k++) {
            ...
            List<CommandNode> cmds = new ArrayList<>(); // Youngest to oldest
            cmds.add(cmd);
            ...
            if (flatten)
                cmds.add(new FuncCommandNode("flatten",
                        labelSpecified ? Collections.singletonList("append") : Collections.emptyList(),
