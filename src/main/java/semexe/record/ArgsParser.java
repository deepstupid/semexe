...
public class ArgsParser {
    ...
    public String get(int i, String defValue) {
        return values[i] == null ? defValue : values[i];
    }

    public String get(String var, String defValue) {
        return get(getArgIndex(var), defValue);
    }

    public int getInt(int i, int defValue) {
        return Utils.parseIntEasy(get(i, null), defValue);
    }

    public int getInt(String var, int defValue) {
        return getInt(getArgIndex(var), defValue);
    }

    public boolean getBoolean(int i, boolean defValue) {
        return Utils.parseBooleanEasy(get(i, null), defValue);
    }

    public boolean getBoolean(String var, boolean defValue) {
        return getBoolean(getArgIndex(var), defValue);
    }

    public double getDouble(int i, double defValue) {
        return Utils.parseDoubleEasy(get(i, null), defValue);
    }

    public double getDouble(String var, double defValue) {
        return getDouble(getArgIndex(var), defValue);
    }

    public String getHard(int i) {
        if (values[i] == null) throw badArg(i);
        return values[i];
    }

    public String getHard(String var) {
        return getHard(getArgIndex(var));
    }

    public int getIntHard(int i) {
        return Utils.parseIntHard(get(i, null));
    }

    public int getIntHard(String var) {
        return getIntHard(getArgIndex(var));
    }

    public boolean getBooleanHard(int i) {
        return Utils.parseBooleanHard(get(i, null));
    }

    public boolean getBooleanHard(String var) {
        return getBooleanHard(getArgIndex(var));
    }

    public double getDoubleHard(int i) {
        return Utils.parseDoubleHard(get(i, null));
    }

    public double getDoubleHard(String var) {
        return getDoubleHard(getArgIndex(var));
    }
}
