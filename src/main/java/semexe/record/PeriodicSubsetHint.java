...
class ConstantOracle implements SubsetOracle {
    ...
    private ConstantOracle(boolean value) {
        this.value = value;
    }
    ...
    public int getUpperBound() {
        return value ? Integer.MAX_VALUE : 0;
    }
...
class ConstantSubsetHint implements SubsetHint {
    ...
    public ConstantSubsetHint(ConstantOracle oracle) {
        this.oracle = oracle;
    }
...
public class PeriodicSubsetHint implements SubsetHint {
    ...
    private static boolean indexRequiresTotalCount(String s) {
    ...
    public boolean needTotalCount() {
        return indexRequiresTotalCount(parser.get("start", "")) ||
                ...
                (!parser.get("stepcount", "").isEmpty() && !parser.get("stepcount", "").startsWith("+"));
    }
