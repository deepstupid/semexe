...
public final class ReinforcementUtils {
    ...
    public static void addToDoubleMap(Map<String, Double> mutatedMap, Map<String, Double> addedMap, String prefix) {
        for (Map.Entry<String, Double> stringDoubleEntry : addedMap.entrySet())
            MapUtils.incr(mutatedMap, prefix + stringDoubleEntry.getKey(), stringDoubleEntry.getValue());
    }

    public static void subtractFromDoubleMap(Map<String, Double> mutatedMap, Map<String, Double> subtractedMap) {
        for (Map.Entry<String, Double> stringDoubleEntry : subtractedMap.entrySet())
            MapUtils.incr(mutatedMap, (String) stringDoubleEntry.getKey(), -1 * stringDoubleEntry.getValue());
    }
    ...
    public static void subtractFromDoubleMap(Map<String, Double> mutatedMap, Map<String, Double> subtractedMap, String prefix) {
        for (Map.Entry<String, Double> stringDoubleEntry : subtractedMap.entrySet())
            MapUtils.incr(mutatedMap, prefix + stringDoubleEntry.getKey(), -1 * stringDoubleEntry.getValue());
    }
