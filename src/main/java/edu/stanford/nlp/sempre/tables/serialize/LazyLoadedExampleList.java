...
public class LazyLoadedExampleList implements List<Example> {
    ...
    private static int readSizeFromMetadata(LispTree tree) {
    ...
    private static String getExampleId(LispTree tree) {
    ...
    private static Example readExample(LispTree tree) {
