...
public class GrammarInducer {
    ...
    private static List<Derivation> bestPackingDP(List<Derivation> matches, int length) {
    ...
    private static Formula renameBoundVars(Formula formula, Set<String> boundvars) {
