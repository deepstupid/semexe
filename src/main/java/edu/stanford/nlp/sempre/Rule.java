...
public class Rule {
    ...
    public static final Rule nullRule = new Rule(null, null, null);
    ...
    public boolean isCatUnary() {
        return rhs.size() == 1 && isCat(rhs.get(0));
    }
    ...
    public LispTree toLispTree() {
        ...
        if (info != null) {
            for (Pair<String, Double> p : info)
                tree.addChild(LispTree.proto.newList(p.getFirst(), String.valueOf(p.getSecond())));
        }
        if (source != null)
    ...
    public boolean isFloating() {
        ...
        if (f == 1.0)
            ...
            return !(a == 1.0) && FloatingParser.opts.defaultIsFloating;
    }
    ...
    public boolean isAnchored() {
        ...
        if (a == 1.0)
            ...
            return !(f == 1.0) && !FloatingParser.opts.defaultIsFloating;
    }
